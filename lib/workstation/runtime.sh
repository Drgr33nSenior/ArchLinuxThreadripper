...
ws_load_config() {
  ...
  unset SUNSHINE_ENCODER SUNSHINE_CAPTURE SUNSHINE_OUTPUT_NAME SUNSHINE_HEVC_MODE SUNSHINE_AV1_MODE SUNSHINE_VK_TUNE SUNSHINE_VAAPI_STRICT_RC_BUFFER
  unset AGENT_HARNESS AGENT_BASE_URL AGENT_MODEL AGENT_CONTEXT_TOKENS AGENT_MAX_OUTPUT_TOKENS
  common::load_config "$config_file" LLM_DATA_DIR LLM_LISTEN LLM_SHM_SIZE DEFAULT_TUNED_PROFILE \
    ...
    SUNSHINE_ENCODER SUNSHINE_CAPTURE SUNSHINE_OUTPUT_NAME SUNSHINE_HEVC_MODE SUNSHINE_AV1_MODE SUNSHINE_VK_TUNE SUNSHINE_VAAPI_STRICT_RC_BUFFER \
