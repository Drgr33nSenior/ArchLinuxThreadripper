...
ws_load_config() {
  local config_file="$1"
  unset SESSION_AI_STARTUP_TIMEOUT_SECONDS WORKSTATION_PYTHON LLAMA_THREADS LLAMA_SPLIT_MODE LLAMA_KV_K LLAMA_KV_V LLAMA_BENCH_PAIRS GAMING_REFRESH_HZ
  ...
  common::load_config "$config_file" SESSION_AI_STARTUP_TIMEOUT_SECONDS WORKSTATION_PYTHON LLAMA_THREADS LLAMA_SPLIT_MODE LLAMA_KV_K LLAMA_KV_V LLAMA_BENCH_PAIRS GAMING_REFRESH_HZ LLM_DATA_DIR LLM_LISTEN LLM_SHM_SIZE DEFAULT_TUNED_PROFILE \
