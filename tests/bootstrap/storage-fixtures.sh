...
lsblk() {
  ...
  case $6 in
    /dev/testnvme0n1p1) number=0; guid=11111111-1111-1111-1111-111111111111 ;;
    /dev/testnvme1n1p1) number=1; guid=22222222-2222-2222-2222-222222222222 ;;
    /dev/testnvme[01]n1)
...
efibootmgr() {
  ...
  for number in 0001 0002 0003 0004 0005 0006; do
    case $number in
      0001|0004) label='stable'; loader=arch-linux.efi ;;
      0002|0005) label='LTS'; loader=arch-linux-lts.efi ;;
      0003|0006) label='recovery'; loader=arch-recovery.efi ;;
    esac
    if [[ $number -gt 3 ]]; then label="$label backup"; guid=22222222-2222-2222-2222-222222222222; fi
